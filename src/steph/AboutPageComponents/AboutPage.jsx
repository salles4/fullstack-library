          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-1/2 mt-10 lg:mt-0 lg:ml-10 text-center lg:text-left">
              ...
              <p className="text-lg opacity-70 mb-5">
                At ShelfWise, we are passionate about connecting readers with a
                diverse range of literature. Our online library system is
                designed to simplify the way you discover, manage, and enjoy
                books.
              </p>
        ...
        <section className="py-10 bg-white text-gray-900">
          <div className="container">
            ...
            <p className="mb-5 leading-relaxed text-lg p-5 text-center">
              At ShelfWise, we are a passionate team of book lovers and
              technology enthusiasts dedicated to transforming the reading
              experience for everyone. Our mission is to provide a user-friendly
              platform that caters to all your reading needs, making literature
              accessible and enjoyable for all. We believe in the power of
              stories to inspire, educate, and connect people. That’s why we’ve
              created a vibrant online community where readers can easily
              explore a vast array of books, engage with authors, and discover
              new genres. Our platform is designed not just to showcase
              literature, but to empower both readers and authors by fostering
              meaningful interactions and encouraging a love for reading.
              Whether you&apos;re a lifelong bibliophile or just starting your
              literary journey, ShelfWise is here to support you.
            </p>
            ...
            <div className="flex justify-center">
              <div className="max-w-6xl flex justify-center items-center content-center text-lg">
                <p className="py-2 hover:bg-gray-100 transition duration-200 rounded-md p-2">
                  📚 Extensive Collection: Explore our vast library featuring a
                  wide range of books across various genres.
                </p>
                <p className="py-2 hover:bg-gray-100 transition duration-200 rounded-md p-2">
                  ✍️ Author Profiles: Discover your favorite authors with
                  biographies and bibliographies.
                </p>
                <p className="py-2 hover:bg-gray-100 transition duration-200 rounded-md p-2">
                  📂 Organized Categories: Navigate our library effortlessly
                  with well-defined categories.
                </p>
                <p className="py-2 hover:bg-gray-100 transition duration-200 rounded-md p-2">
                  🛠️ Simple CRUD Functionality: Easily manage authors, books,
                  and categories.
                </p>
              </div>
            </div>
