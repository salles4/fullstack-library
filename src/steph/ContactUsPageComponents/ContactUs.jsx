...
const ContactUs = () => {
    ...
    return (
        <main className='container'>
                    ...
                    <div className='flex flex-row container mx-auto gap-10 items-start p-6 bg-gray-100 '>
                        ...
                        <div className="flex flex-col space-y-4 flex-1 ">
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="font-semibold">Location: 123 Main St, City, Country</p>
                            </div>
                        </div>
                    </div>
            ...
            <section >
                <h1 className="text-4xl font-semibold mb-8 text-center text-gray-800">Contacts</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 bg-gray-50 p-6">
                    {contacts.length > 0 ? (
                        contacts.map((contact) => (
                            <div key={contact._id} className="bg-white p-6 rounded-lg shadow-lg text-center flex flex-col transition-transform transform hover:scale-105">
                                <div className="font-semibold text-lg text-gray-900">Name: {contact.name}</div>
                                <div className="text-gray-700">Phone Number: {contact.phone}</div>
                                <div className="text-gray-700">Email: {contact.email}</div>
                                <div className="text-gray-700">Message: {contact.message}</div>
                            </div>
                        ))
                    ) : (
